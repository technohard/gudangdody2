    ...
    <div class="page-inner py-4">
      <div class="page-header text-white">
        ...
        <ul class="breadcrumbs">
          ...
          <li class="nav-item"><a href="?module=barang_masuk" class="text-white"><?php echo transWord($_SESSION['Lang'],'stokOpname','Stok Opname') ?></a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title"><?php echo transWord($_SESSION['Lang'],'entriDataStokOpname','Entri Data Stok Opname') ?></div>
      </div>
      <!-- form entri data -->
      <form action="modules/stok-opname/proses_entri.php" method="post" class="needs-validation" novalidate>
        <div class="card-body">
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                ...
                ($query = mysqli_query($mysqli, 'SELECT RIGHT(id_transaksi,7) as nomor FROM tbl_stok_opname ORDER BY id_transaksi DESC LIMIT 1')) or die('Ada kesalahan pada query tampil data : ' . mysqli_error($mysqli));
                ...
                $id_transaksi = 'SO-' . str_pad($nomor_urut, 7, '0', STR_PAD_LEFT);
                ?>
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                ...
                <div class="invalid-feedback"><?php echo transWord($_SESSION['Lang'],'Barang tidak boleh kosong','Barang tidak boleh kosong') ?>  <span class="text-danger">.</div>
              </div>
              ...
              <div class="form-group">
                <label><?php echo transWord($_SESSION['Lang'],'keterangan','Keterangan') ?></label>
            ...
            <div class="col-md-5 ml-auto">
              <div class="form-group">
                <label><?php echo transWord($_SESSION['Lang'],'jumlah','Jumlah') ?> <span class="text-danger">*</span></label>
                ...
                <div class="invalid-feedback"><?php echo transWord($_SESSION['Lang'],'Jumlah tidak boleh kosong','Jumlah tidak boleh kosong') ?>.</div>
              </div>
      ...
      $(document).ready(function() {
        ...
        $('#data_barang').change(function() {
          ...
          $.ajax({
            ...
            url: "modules/stok-opname/get_barang.php", // proses get data berdasarkan "id_barang"
            data: {
              id_barang: id_barang
            }, // data yang dikirim
