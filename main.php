...
// jika user sudah login, tampilkan halaman konten
  ...
  <body>
          ...
          <div class="container-fluid">
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
              ...
              <li class="nav-item dropdown">
                <button class="btn btn-secondary pilihBahasa dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                 <!-- 语言 -->
                  <?php 
                      $lang = getLang(''); 
                      if($lang=='Mandarin'){
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="#" onclick="setLang('Bahasa')">Bahasa</a>
                  <a class="dropdown-item" href="#" onclick="setLang('Mandarin')">普通话</a>
                </div>
              </li>
    ...
    <script>
      ...
      var domain = protocol + "//" + window.location.hostname  + "/gudangdody2";
