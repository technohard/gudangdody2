  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul tabel -->
        <div class="card-title"><?php echo transWord($_SESSION['Lang'],'dataBarangMasuk','Data Barang Masuk') ?> </div>
      </div>
      <div class="card-body">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center"><?php echo transWord($_SESSION['Lang'],'dokumenPabean','Dokumen Pabean') ?></th>
                <th class="text-center"><?php echo transWord($_SESSION['Lang'],'nomorDokumen','Nomor Dokumen') ?></th>
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.jumlah, b.nama_barang, c.nama_satuan, a.jns_dok, a.tgl_dok, a.no_dok
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="60"><?php echo $data['nama_satuan']; ?></td>
                   <td width="60"><?php echo $data['jns_dok']; ?></td>
                    <td width="60"><?php echo $data['no_dok'];; ?></td>
