  ...
  <div class="panel-header bg-secondary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-clone mr-2"></i> Barang Adjustmet</h4>
        <!-- breadcrumbs -->
      ...
      <form action="modules/laporan_adjustmen/proses_entri.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="card-body">
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="tanggale" id="tanggale" class="form-control" autocomplete="off" required>
          ...
          <div class="col-md-7">
            ...
            <div class="form-group">
              <label>Penyesuaian<span class="text-danger">*</span></label>
