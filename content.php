...
// jika file di include oleh file lain, tampilkan isi file
  ...
  elseif ($_GET['module'] == 'stok_opname' && $_SESSION['hak_akses'] != 'Kepala Gudang') {
    // panggil file tampil data barang masuk
    include "modules/stok-opname/tampil_data.php";
  }
  elseif ($_GET['module'] == 'form_entri_stok_opname' && $_SESSION['hak_akses'] != 'Kepala Gudang') {
    // panggil file form entri barang masuk
    include "modules/stok-opname/form_entri.php";
  }
  ...
  elseif ($_GET['module'] == 'laporan_stok') {
   ...
   elseif ($_GET['module'] == 'laporan_adjustmen') {
    // panggil file tampil data laporan stok
    include "modules/laporan_adjustmen/tampil_data.php";
  }
  
  
     elseif ($_GET['module'] == 'form_entri_adjustment') {
    // panggil file tampil data laporan stok
    include "modules/laporan_adjustmen/form_entri_2.php";
  }
