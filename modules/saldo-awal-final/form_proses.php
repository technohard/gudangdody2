...
<?php
  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Saldo Awal Final berhasil diproses. '.$message.'</span>
    ...
    elseif ($_GET['pesan'] == 4) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Saldo Awal Final gagal diproses. '.$message.'</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
  ...
  <div class="panel-header bg-secondary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-user mr-2"></i> <?php echo transWord($_SESSION['Lang'],'saldoAwalFinal','Saldo Awal Final') ?> </h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          <li class="nav-home"><a href="?module=dashboard"><i class="flaticon-home text-white"></i></a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a href="?module=form_ubah_profil" class="text-white"><?php echo transWord($_SESSION['Lang'],'saldoAwalFinal','Saldo Awal Final') ?></a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      ...
      <!-- form ubah data -->
      <form action="modules/saldo-awal-final/proses_final.php" method="post" class="needs-validation" novalidate>
        <div class="card-body">
