  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data stok opname berhasil disimpan.</span>
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data stok opname berhasil dihapus.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
        ...
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              b.nama_barang, c.nama_satuan,d.nama_jenis,a.keterangan
                                              FROM tbl_stok_opname as a 
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="90" class="text-center"><?php echo $data['nama_jenis']; ?></td>
                  ...
                  <td width="50" class="text-center">
                    <div>
                      <!-- tombol hapus data -->
                      <a href="modules/stok-opname/proses_hapus.php?id=<?php echo $data['id_transaksi']; ?>" onclick="return confirm('Anda yakin ingin menghapus data stok opname <?php echo $data['id_transaksi']; ?>?')" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus">
