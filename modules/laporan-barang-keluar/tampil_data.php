  ...
  <div class="panel-header bg-secondary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-file-export mr-2"></i> <?php echo transWord($_SESSION['Lang'],'laporanBarangKeluar','Laporan Barang Keluar') ?> </h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          ...
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a><?php echo transWord($_SESSION['Lang'],'barangKeluar','Barang Keluar') ?> </a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="page-inner mt--5">
      <div class="card">
        <div class="card-header">
          <!-- judul form -->
          <div class="card-title"><?php echo transWord($_SESSION['Lang'],'filterDataBarangKeluar','Filter Data Barang Keluar') ?> </div>
        </div>
        <!-- form filter data -->
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class="fas fa-file-alt mr-2"></i> <?php echo transWord($_SESSION['Lang'],'laporanDataBarangKeluarTanggal','Laporan Data Barang Keluar Tanggal') ?>  <strong><?php echo $tanggal_awal; ?></strong> s.d. <strong><?php echo $tanggal_akhir; ?></strong>
          </div>
        </div>
        <div class="card-body">
