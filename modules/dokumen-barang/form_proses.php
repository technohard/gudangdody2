...
?>
  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Dokumen Barang berhasil diproses. ' . $message . '</span>
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Dokumen Barang gagal diproses. ' . $message . '</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
  ...
  <div class="panel-header bg-secondary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-user mr-2"></i> <?php echo transWord($_SESSION['Lang'],'dokumenBarang','Dokumen Barang') ?> </h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          <li class="nav-home"><a href="?module=dashboard"><i class="flaticon-home text-white"></i></a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a href="?module=form_ubah_profil" class="text-white"><?php echo transWord($_SESSION['Lang'],'dokumenBarang','Dokumen Barang') ?></a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      ...
      <!-- form ubah data -->
      <form action="modules/dokumen-barang/proses_dokumen.php" method="post" class="needs-validation" novalidate>
        <div class="card-body">
          <input type="hidden" name="id_profil" value="<?php echo $data['id_profil']; ?>">

          <div class="form-group col-lg-5">
            <label><?php echo transWord($_SESSION['Lang'],'tipe','Tipe') ?>  <span class="text-danger">*</span></label>
            <select name="tipe_dokumen" id="tipe_dokumen" class="form-control">
              <option value=""> - </option>
              <option value="idTransaksi">By Id Transaksi</option>
              <option value="idBarangTransaksi">By Id Barang Transaksi</option>
            </select>

          </div>

          <div class="form-group col-lg-5">
            <label><?php echo transWord($_SESSION['Lang'],'iD','ID') ?>   <span class="text-danger">*</span></label>
            <input type="text" name="idtrans" class="form-control" autocomplete="off" value="" required>
          ...
          <div class="form-group col-lg-5">
            <label><?php echo transWord($_SESSION['Lang'],'kodeDokumen','Kode Dokumen') ?>  <span class="text-danger">*</span></label>
            <input type="text" name="kodeDokumen" class="form-control" autocomplete="off" value="" required>
            <!-- <div class="invalid-feedback">Npwp tidak boleh kosong.</div> -->
          </div>

          <div class="form-group col-lg-5">
            <label><?php echo transWord($_SESSION['Lang'],'nomorDokumen','Nomor Dokumen') ?>  <span class="text-danger">*</span></label>
            <input type="text" name="nomorDokumen" class="form-control" autocomplete="off" value="" required>
            <!-- <div class="invalid-feedback">Npwp tidak boleh kosong.</div> -->
          </div>

          <div class="form-group col-lg-5">
            <label><?php echo transWord($_SESSION['Lang'],'tanggalDokumen','Tanggal Dokumen') ?>  </label>
            <input type="text" name="tanggalDokumen" class="form-control date-picker" autocomplete="off" value="<?php echo date('d-m-Y'); ?>">
